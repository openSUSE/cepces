...
@deco.decorator
def catch_and_return_token(func: t.Callable, self: SecurityContext, *args: t.Any, **kwargs: t.Any) -> bytes | None: ...
@deco.decorator
def check_last_err(func: t.Callable, self: SecurityContext, *args: t.Any, **kwargs: t.Any) -> t.Any: ...

class CheckLastError(type):
    def __new__(cls, name: str, parents: tuple[type], attrs: dict[str, t.Any]) -> CheckLastError: ...
